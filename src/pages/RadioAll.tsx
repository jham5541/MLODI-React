...
export default function RadioAllScreen() {
  ...
  const featuredStations: RadioStation[] = [
    {
      ...
      coverUrl: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600&h=400&fit=crop',
      isLive: true,
      listeners: 1247,
      isFeatured: true,
    },
    {
      ...
      coverUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=400&fit=crop',
      isLive: true,
      listeners: 834,
      isFeatured: true,
    },
    {
      ...
      coverUrl: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=600&h=400&fit=crop',
      isLive: true,
      listeners: 956,
      isFeatured: true,
    },
  ...
  const allStations: RadioStation[] = [
    ...featuredStations,
    {
      ...
      coverUrl: 'https://images.unsplash.com/photo-1577648188599-291bb8b831c3?w=400&h=400&fit=crop',
      isLive: true,
      listeners: 723,
    },
    {
    ...
    },
    {
      ...
      coverUrl: 'https://images.unsplash.com/photo-1460723237483-7a6dc9d0b212?w=400&h=400&fit=crop',
      isLive: true,
      listeners: 587,
    },
    {
      ...
      coverUrl: 'https://images.unsplash.com/photo-1519412666065-94acb3f8838f?w=400&h=400&fit=crop',
      isLive: false,
      listeners: 234,
    },
    {
      ...
      coverUrl: 'https://images.unsplash.com/photo-1504854926756-d648e6e87a01?w=400&h=400&fit=crop',
      isLive: true,
      listeners: 678,
    },
  ];
